...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../FP_TLOZ_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is FP_TLOZ_soc
SOPC_NAME := FP_TLOZ_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682557382
SOPC_SYSID_FLAG += --timestamp=1682557382
ELF_PATCH_FLAG  += --timestamp 1682557382
